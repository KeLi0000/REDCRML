...
from memory import ReplayBuffer, PrioritizedReplayBuffer, MfteReplayBuffer
from network import BlpnCritic, BlpnActor, device, CriticLoss
...
class REDCRML(object):
    ...
    def _build_actor_network(self) -> BlpnActor:
        return BlpnActor(
    ...
    def _build_critic_network(self) -> BlpnCritic:
        return BlpnCritic(
